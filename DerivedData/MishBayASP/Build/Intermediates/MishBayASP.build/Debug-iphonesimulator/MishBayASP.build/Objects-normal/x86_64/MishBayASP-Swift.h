...
SWIFT_CLASS("_TtC10MishBayASP11AppDelegate")
...
SWIFT_CLASS("_TtC10MishBayASP17BidViewController")
@interface BidViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified bidAmountTextField;
@property (nonatomic, copy) NSString * _Null_unspecified id;
@property (nonatomic, readonly, copy) NSString * _Nonnull BidURL;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)bidTapped:(UIButton * _Nonnull)sender;
- (IBAction)emptyTextFieldAlert;
- (IBAction)bidSuccessAlert;
- (IBAction)bidFailureAlert;
...
@property (nonatomic, readonly, copy) NSString * _Nonnull GetImageURL;
- (void)viewDidLoad;
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified passwordTextField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified emailTextField;
@property (nonatomic, readonly, copy) NSString * _Nonnull CreateUserURL;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
...
SWIFT_CLASS("_TtC10MishBayASP14ViewController")
